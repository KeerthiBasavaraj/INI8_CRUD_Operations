This project is built using Java, JDBC, Servlet and as backend and HTML, CSS, JSP and Bootstrap as frontend. According to the requirements given, I have performed CRUD operations on Registration table.
